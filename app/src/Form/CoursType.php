    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('id_classe', EntityType::class, [
                ...
                'expanded' => false, // pour une sélection de type 'select', mettre à true pour des checkboxes
                'label' => 'Classes',
                'attr' => ['class' => 'your-custom-class-for-select'],
                'label_attr' => ['class' => 'your-custom-class-for-label'],
